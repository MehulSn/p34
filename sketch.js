...
function setup() {
  ...
  box1 = new Box(800, 100, 80, 80);
  box2 = new Box(800, 100, 80, 80);
  box3 = new Box(800, 100, 80, 80);
  box4 = new Box(800, 100, 80, 80);
  ...
  box17 = new Box(600, 100, 80, 80);
  box18 = new Box(600, 100, 80, 80);
  box19 = new Box(600, 100, 80, 80);
  box20 = new Box(600, 100, 80, 80);
